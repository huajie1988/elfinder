...
/**
 * Simplified Chinese translation
 * @author 翻译者 <whuajie1988@gmail.com>
 * @version 2013-08-18
 */

if (elFinder && elFinder.prototype && typeof(elFinder.prototype.i18) == 'object') {
	elFinder.prototype.i18.zh_CN = {
		translator : '翻译者 &lt;deerchao@gmail.com&gt;&nbsp;&nbsp;&lt;whuajie1988@gmail.com&gt;',
		language   : '简体中文',
		direction  : 'ltr',
		messages   : {
			...
			'errReplByChild'       : '文件夹 “$1” 不能被替换 因为某些文件正在被使用.',
			'errArcSymlinks'       : '出于安全的原因拒绝解压档案包含符号链接.',
			'errArcMaxSize'        : '压缩文件超过最大允许值.',
			'errResize'            : '不能重新设定大小 "$1".',
			...
			'Sat'         : '周六',
			/******************************** sort variants ********************************/
			'sortnameDirsFirst' : '按文件名排序 (文件夹优先)', 
			'sortkindDirsFirst' : '按类型排序 (文件夹优先)', 
			'sortsizeDirsFirst' : '按大小排序 (文件夹优先)', 
			'sortdateDirsFirst' : '按日期排序 (文件夹优先)', 
			'sortname'          : '按文件名排序', 
			'sortkind'          : '按类型排序', 
			'sortsize'          : '按大小排序',
			'sortdate'          : '按日期排序',
